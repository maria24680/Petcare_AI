    ...
    return (
        <div>
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-[#111844]">Add New Pet</h1>
                    <p className="text-gray-600 mt-1">Register a new furry family member</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <label htmlFor="isPublic" className="text-sm text-gray-700">
                            Make pet profile public (visible to everyone)
                        </label>
                    </div>
